  ...
  return (
    <div>
        <div className='mt-5 p-5 container' style={{height: "100vh"}}>
            <h2 className='mt-4'>Film Add</h2>
            <hr />

            <h5 className='my-4'>
                Fill in the movie information completely and proceed to choose the actors of the movie.
            </h5>
            ...
            <Formik 
                ...
                <div class="form-floating mb-3">
                    <KaanKaplanTextInput  type="text" name='movieName' class="form-control" id="floatingInput" placeholder="Film Name" />
                ...
                <div class="form-floating mb-3">
                    <KaanKaplanTextInput name='releaseDate' type="date" class="form-control" id="releaseDate" placeholder="Vision date" />
                    <label for="releaseDate">Vision date</label>
                </div>
                ...
                <p>If the director is not listed above, please write.</p>
                <div class="form-floating mb-3">
